...
#error "Unknown endianess on this platform."
    ...
    GmicQt::RunParameters GetFilterRunParameters(const QString& path)
    {
        ...
        parameters.command = std::string();
        parameters.filterPath = std::string();
        parameters.inputMode = GmicQt::InputMode::Active;
        parameters.outputMode = GmicQt::OutputMode::InPlace;
